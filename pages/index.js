  ...
  return (
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-full minmd:w-4/5">
        <Banner
          name="Discover and Enhance Knowledge Through NFTs"
          childStyles="md:text-4xl sm:text-2xl xs=text-xl text-left"
          parentStyles="justify-start mb-6 h-72 sm:h-60 p-12 xs:p-4 xs:h-44 rounded-3xl"
        />
        <div>
          <h1 className="font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 xs:ml-0">Top Content creators</h1>
          <div
        ...
        <div className="mt-3 w-full flex flex-wrap justify-start md:justify-center">
          {nfts && nfts.map((nft) => <NFTCard key={nft.owner} nft={nft} />)}
          {/* {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((i) => (
            <NFTCard
              ...
              nft={{
                ...
                description: 'Knowledge through Nft',
              }}
            />
          ))} */}
        </div>
